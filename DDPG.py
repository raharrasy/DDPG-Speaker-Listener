...
"""
Updates Using polyak averaging
"""
...
"""
Updates by copying parameters for target network, a la DQN
"""
...
class Actor(nn.Module):
    def __init__(self, hidden_size, num_inputs, action_space):
        ...
        self.linear2.weight = torch.nn.Parameter(torch.zeros(D_in,H))
        self.linear2.bias = torch.nn.Parameter(torch.ones(H))
